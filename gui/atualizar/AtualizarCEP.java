...
public class AtualizarCEP extends JFrame implements ActionListener, FocusListener {
    JMenuBar barraMenu;
    ...
    public AtualizarCEP(String nome, String cnpj, String ie) {
        this.nome = nome;
        this.cnpj = cnpj;
        this.ie = ie;
        setTitle("Atualizar CEP");
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == cancelar) {
            ...
            if (confirmacao == 0) {
                setVisible(false);
                new AtualizarForne(nome, cnpj, ie);
            }
        }
    }
