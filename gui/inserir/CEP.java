...
public class CEP extends JFrame implements ActionListener, FocusListener {
    JMenuBar barraMenu;
    ...
    public CEP(String nome, String cnpj, String ie) {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == ok) {
            ...
            if (confirmacao == 0) {
                int CEP = Integer.parseInt(tCEP.getText());
